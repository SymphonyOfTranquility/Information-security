...
if __name__ == '__main__':
    ...
    check(hash_256_1, kupyna(test[:64], 256))
    check(hash_256_2, kupyna(test[:128], 256))
    check(hash_256_3, kupyna(test[:256], 256))
    check(hash_256_4, kupyna(test_8, 256))
    check(hash_256_5, kupyna(test[:95], 256))
    check(hash_256_6, kupyna(test[:0], 256))

    check(hash_48, kupyna(test[:64], 48))

    check(hash_512_1, kupyna(test[:64], 512))
    check(hash_512_2, kupyna(test[:128], 512))
    check(hash_512_3, kupyna(test[:256], 512))
    check(hash_512_4, kupyna(test_8, 512))
    check(hash_512_6, kupyna(test[:0], 512))

    check(hash_304, kupyna(test[:128], 304))
    check(hash_384_1, kupyna(test[:95], 384))